...
<head>
        ...
        <title>News - Al Omariya Institute</title>
                                ...
                                <div class="col-md-6 col-sm-6 col-lg-4">
                                    <div class="post-box w-100 text-center">
                                        <div class="post-img overflow-hidden w-100">
                                            <a href="/khabar/{{$new->id}}" title=""><img class="img-fluid w-100" src="{{Voyager::image($new->image)}}" alt="Post Image 1"></a>
                                        </div>
                                        <div class="post-info w-100">
                                            <h3 class="mb-0"><a href="/khabar/{{$new->id}}" title="">{{$new->title}}</a></h3>
                                            <p class="mb-0">{!! html_entity_decode(substr($new->description, 0, 400)) !!}</p>
                                            <div class="post-info-bottom d-flex flex-wrap w-100">
                                                <span class="d-inline-block"><i class="far fa-user"></i><a href="" title="">{{$new->author}}</a></span>
                                                <ul class="post-meta mb-0 list-unstyled d-inline-flex">
                                                    <li><i class="far fa-calendar-alt"></i>{{$new->created_at}}</li>
