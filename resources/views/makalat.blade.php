...
<head>
        ...
        <title>Makalat - Al Omariya Institute</title>
                                ...
                                <div class="col-md-6 col-sm-6 col-lg-4">
                                    <div class="post-box w-100 text-center">
                                        <div class="post-img overflow-hidden w-100">
                                            <a href="/makal/{{$article->id}}" title=""><img class="img-fluid w-100" src="{{Voyager::image($article->image)}}" alt="Post Image 1"></a>
                                        </div>
                                        <div class="post-info w-100">
                                            <h3 class="mb-0"><a href="/makal/{{$article->id}}" title="">{{$article->title}}</a></h3>
                                            <p class="mb-0">{!! html_entity_decode(substr($article->description, 0, 400)) !!}</p>
                                            <div class="post-info-bottom d-flex flex-wrap w-100">
                                                <span class="d-inline-block"><i class="far fa-user"></i><a href="" title="">{{$article->author}}</a></span>
