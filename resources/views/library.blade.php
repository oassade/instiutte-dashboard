...
<head>
        ...
        <title>Library - Al Omariya Institute</title>
        ...
        <main>
            ...
            <section>
                <div class="w-100 pt-170 pb-150 dark-layer3 opc7 position-relative">
                    ...
                    <div class="container">
                        <div class="page-top-wrap w-100 text-right">
                            <h1 class="mb-0">المكتبة</h1>
                        </div><!-- Page Top Wrap -->
                    </div>
                </div>
            </section>
                            ...
                            @foreach($libraries as $library)
                                <div class="col-md-4 col-sm-6 col-lg-3">
                                    <div class="shop-box w-100">
                                        <div class="shop-img w-100 position-relative overflow-hidden text-center">
                                            <img class="img-fluid w-100" src="{{Voyager::image($library->image)}}" alt="Shop Image 1">
                                            <a download="{{$library->file}}" href="" title="">قراءة وتحميل<i class="fas fa-book"></i></a>
                                        </div>
                                        <div class="shop-info w-100 text-center">
                                            <h3 class="mb-0" style="font-size: 18px;"><a href="" title="">{{$library->title}}</a></h3>
                                            <div class="shop-info-bottom justify-content-between w-100 text-center">
                                                <p style="font-size: 13px; margin-top: -10px;">{{$library->author}}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
