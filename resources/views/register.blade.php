...
<head>
        ...
        <title>Register - Al Omariya Institute</title>
    ...
    <body>
        <main>
            ...
            <section>
                <div class="text-right w-100 pt-170 pb-150 dark-layer3 opc7 position-relative">
                        ...
                        <form class=" contact-form text-center w-100" action="#" method="post" id="email-form">
                            <div class="row ">
                                ...
                                <div class="col-md-6 col-sm-6 col-lg-6">
                                    ...
                                    <input class="fname text-right" type="text" name="fname">
                                </div>
                                <div class="col-md-12 col-sm-12 col-lg-12">
                                    <label class="d-block" style="float: right">: اكتب سؤالك</label>
                                    <textarea class="contact_message text-right" name="contact_message"></textarea>
                                    <button class="thm-btn thm-bg" id="submit" type="button"><i class="flaticon-arrow-pointing-to-left"></i>             إرسال</button>
                                </div>
                            </div>
                        </form><!-- Contact Form -->
                    </div>
        ...
        <script src="{{asset('js/google-map-int.js')}}"></script>
