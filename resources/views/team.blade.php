...
<html lang="en">
    ...
    <head>
        ...
        <title>Team - Al Omariya Institute</title>
                ...
                <div class="w-100 pt-170 pb-150 dark-layer3 opc7 position-relative text-right">
                    ...
                    <div class="container">
                        <div class="page-top-wrap w-100 ">
                            <h1 class="mb-0">مجلس الأُمَناء</h1>
                        </div><!-- Page Top Wrap -->
                    </div>
                </div>
            </section>
                ...
                <div class="w-100 pt-100 pb-55 position-relative">
                        ...
                        <ul class="team-wrap d-flex flex-wrap justify-content-center w-100 list-unstyled mb-0">   
                            <li class="team-box text-center mb-45 w-100">
                                <div class="team-img rounded-circle position-relative overflow-hidden">
                                    <img class="rounded-circle img-fluid" src="{{asset('images/resources/team-img1-10.jpg')}}" alt="Team Image 10">
                                    <div class="team-social position-absolute">
                                        <a class="rounded-circle" href="mailto:abdelrhaniomari@gmail.com" title="Mail" target="_blank"><i class="fas fa-envelope"></i></a>
                                    </div>
                                </div>
                                <div class="team-info w-100">
                                    <h3 class="mb-0">الشيخ عبد الغني العمري</h3>
                                    <span class="d-block">المشرف العام</span>
                                    <span class="d-block">abdelrhaniomari@gmail.com</span>
                                </div>
                            </li>
                        </ul>
                    </div>
                    <div class="container">
                        <ul class="team-wrap d-flex flex-wrap justify-content-center w-100 list-unstyled mb-0">
                            ...
                            <li class="team-box text-center mb-45 w-100">
                                <div class="team-img rounded-circle position-relative overflow-hidden">
                                    <img class="rounded-circle img-fluid" src="{{Voyager::image($member->picture)}}" alt="Team Image 10">
                                    <div class="team-social position-absolute">
                                        <a class="rounded-circle" href="mailto:@gmail.com" title="Mail" target="_blank"><i class="fas fa-envelope"></i></a>
                                    </div>
                                </div>
                                <div class="team-info w-100">
                                    <h3 class="mb-0">{{$member->name}}</h3>
                                    <span class="d-block">{{ $member->job}}</span>
